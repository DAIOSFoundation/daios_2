...
import (
	...
	prometheus "github.com/dai/go-ipfs/gxlibs/github.com/prometheus/client_golang/prometheus"
	promhttp "github.com/dai/go-ipfs/gxlibs/github.com/prometheus/client_golang/prometheus/promhttp"
)
...
func MetricsCollectionOption(handlerName string) ServeOption {
	return func(_ *core.IpfsNode, _ net.Listener, mux *http.ServeMux) (*http.ServeMux, error) {
		// Adapted from github.com/dai/go-ipfs/gxlibs/github.com/prometheus/client_golang/prometheus/http.go
