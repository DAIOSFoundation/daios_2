...
import (
	...
	"github.com/dai/go-ipfs/gxlibs/github.com/golang/mock/mockgen/tests/custom_package_name/client/v1"

	//  matching import suffix and package name
	"github.com/dai/go-ipfs/gxlibs/github.com/golang/mock/mockgen/tests/custom_package_name/validator"
)
