...
import (
	...
	mp "github.com/dai/go-ipfs/gxlibs/github.com/libp2p/go-mplex"          // Conn is a connection to a remote peer.
	smux "github.com/dai/go-ipfs/gxlibs/github.com/libp2p/go-stream-muxer" // Conn is a connection to a remote peer.
)
