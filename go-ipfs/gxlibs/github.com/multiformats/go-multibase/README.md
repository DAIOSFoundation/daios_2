...
> Implementation of [multibase](https://github.com/dai/go-ipfs/gxlibs/github.com/multiformats/multibase) -self identifying base encodings- in Go.
...
```sh
go get github.com/dai/go-ipfs/gxlibs/github.com/multiformats/go-multibase
```
...
gx init
gx import github.com/dai/go-ipfs/gxlibs/github.com/multiformats/go-multibase
gx install --global
gx-go --rewrite
```
...
Contributions welcome. Please check out [the issues](https://github.com/dai/go-ipfs/gxlibs/github.com/multiformats/go-multibase/issues).
